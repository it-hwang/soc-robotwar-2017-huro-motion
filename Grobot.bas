...
오른쪽회전_중4:
    ...
    SPEED 10
    MOVE G6A,95,  62, 125,  130, 105, 100
    MOVE G6D,95,  122, 125,  70, 105, 100
    WAIT

    SPEED 12
    MOVE G6A,93,  62, 125,  130, 105, 100
    MOVE G6D,93,  122, 125,  70, 105, 100
    WAIT
...
왼쪽회전_중4:
    ...
    SPEED 10
    MOVE G6A,95,  122, 125,  70, 105, 100
    MOVE G6D,95,  62, 125,  130, 105, 100
    WAIT

    SPEED 12
    MOVE G6A,93,  122, 125,  70, 105, 100
    MOVE G6D,93,  62, 125,  130, 105, 100
    WAIT
...
신걷기제작프로젝트:
    ...
    '***********************************************
    ' [SMART MOTION V.1 - KALSRAN] 2017-08-11 초기제작
    '***********************************************
    ' 1) 걸음수를 입력받는다.
    ' 2) 기존 전진보행의 경우 2걸음이였다.
...
빠른짧은전진보행2_반복_왼쪽_2:
    MOVE G6A, 103, 87, 120, 110, 100
    MOVE G6D, 95, 99, 125, 92, 102
    WAIT

    RETURN

빠른짧은전진보행2_반복_왼쪽_2_끝:
    MOVE G6D, 95, 106, 105, 102, 104
    MOVE G6A, 104, 92, 125, 98, 102
    MOVE G6C, 100
    MOVE G6B, 100
    WAIT
...
빠른짧은전진보행2_반복_오른쪽_2:
    MOVE G6D, 103, 87, 120, 110, 100
    MOVE G6A, 95, 99, 125, 92, 102
    WAIT

    RETURN

빠른짧은전진보행2_반복_오른쪽_2_끝:
    MOVE G6A, 95, 106, 105, 102, 104
    MOVE G6D, 104, 92, 125, 98, 102
    MOVE G6B, 100
    MOVE G6C, 100
    WAIT
...
빠른전진보행2:
    ...
    FOR I = 1 TO B
        IF A = 0 THEN
            ...
            GOSUB 빠른전진보행2_반복_왼쪽_2
        ELSE
            GOSUB 빠른전진보행2_반복_오른쪽_1
            GOSUB 빠른전진보행2_반복_오른쪽_2
        ENDIF
        A = 1 - A
    NEXT I
...
빠른짧은전진보행2:
    ...
    FOR I = 1 TO B
        IF A = 0 THEN
            GOSUB 빠른짧은전진보행2_반복_왼쪽_1
            GOSUB 빠른짧은전진보행2_반복_왼쪽_2
        ELSE
            GOSUB 빠른짧은전진보행2_반복_오른쪽_1
            GOSUB 빠른짧은전진보행2_반복_오른쪽_2
        ENDIF
        A = 1 - A
    NEXT I
    ...
    IF A = 0 THEN
        GOSUB 빠른짧은전진보행2_반복_왼쪽_1
        GOSUB 빠른짧은전진보행2_반복_왼쪽_2_끝
    ELSE
        GOSUB 빠른짧은전진보행2_반복_오른쪽_1
        GOSUB 빠른짧은전진보행2_반복_오른쪽_2_끝
    ENDIF
...
빠른짧은전진보행3:
    ...
    FOR I = 1 TO B
        IF A = 0 THEN
            GOSUB 빠른짧은전진보행3_반복_왼쪽
        ELSE
            GOSUB 빠른짧은전진보행3_반복_오른쪽
        ENDIF
        A = 1 - A
    NEXT I
...
왼쪽회전_약2:
    ...
    MOVE G6A,100, 112, 125, 100, 100
    MOVE G6D,100, 72 125, 100, 100
    WAIT
...
오른쪽회전_약2:
    ...
    MOVE G6A,100, 72, 125, 100, 100
    MOVE G6D,100, 112, 125, 100, 100
    WAIT
